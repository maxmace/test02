...
To be fair, the late 80s Microverb II sound is a bit more polished than the original mid 80s Microverb. Alesis algorithms were renowned for pulling maximum lushness from the available processing power. 

But we are not here for normal plate or hall effects. We are here because this unit can accomplish an effect it would be hard to achieve otherwise. 

## Deep Space
Before the two ubiquitous 1980 gate effects, the Microverb II programs grow increasingly large, from small ambience to the aptly named “Large 4: Deep Space”. Strictly speaking, Deep Space is a Hall effect (not to be confused with the Hall coefficient!). Deep Space is understandably useless to most musicians. Its something of an ENDLESS hall effect. You could do something like this with a Lexicon and a delay with the perfect feedback setting, but it likely wouldn’t sound as good as “Deep Space”. With their preset “Large 4”, Alesis has produced an essential space music effect. 
