...
To be fair, the Microverb II sound is a bit more polished than the original Microverb. Alesis algorithms were renowned for pulling maximum lushness from the available processing power. 
