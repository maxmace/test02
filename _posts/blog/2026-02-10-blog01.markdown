...
In the realm of cinematic space music, the argument often shifts from the *sound* to the machine that makes the sound.  My goal is always to remain somewhat focused on the composition and performance itself and not the hardware. I’d like to think when composing for a dome environment, the spatial awareness required of the composer helps inform the composition. 

![Yamaha CS-80 – the king of polysynths](https://commons.wikimedia.org/wiki/File:Yamaha_CS-80_(1977)_8-voices_dual-layered_analog_polyphonic_synthesizer,_with_22_preset_sounds_%26_6_user_patches_-_VINTAGE_SYNTH_@_YAMAHA_BOOTH_-_2015_NAMM_Show.jpg#/media/File:Yamaha_CS-80_(1977)_8-voices_dual-layered_analog_polyphonic_synthesizer,_with_22_preset_sounds_&_6_user_patches_-_VINTAGE_SYNTH_@_YAMAHA_BOOTH_-_2015_NAMM_Show.jpg)

But it might be closer to the truth that the synthesizer and recording hardware of the 1970’s enforced a kind of musical argot in the same way that classical composers approached instruments like the harpsichord or valveless trumpet. The capabilities and limitations of the sound creation “machines” combined with the musical modes-of-the-day to create the lightning in a bottle that inspired generations. 
...
![The Zeiss ZKP-3B – A truly striking planetarium projector](https://share.google/tVRvxW5tJ41tAbIQW)
